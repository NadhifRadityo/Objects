...
public interface Sorting {
	...
	@SuppressWarnings("unchecked")
	default <T> void sort(Object object, Comparator<T> comparator) { int length;
	...
	default <T extends Comparable<? super T>> void sort(Object object, int start, int end) { if(!(object instanceof Comparable)) throw new IllegalArgumentException("Object is not comparable"); sort(object, Comparator.<T>naturalOrder(), start, end); }
	default <T extends Comparable<? super T>> void sort(Object object) { if(!(object instanceof Comparable)) throw new IllegalArgumentException("Object is not comparable"); sort(object, Comparator.<T>naturalOrder()); }
