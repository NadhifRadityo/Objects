...
public class ByteUtils {
	...
	public static boolean hasZeroByte(short value) { return ((value - 0x0101) & ~value & 0x8080) != 0; }
	public static boolean hasZeroByte(int value) { return ((value - 0x01010101) & ~value & 0x80808080) != 0; }
	public static boolean hasZeroByte(long value) { return ((value - 0x0101010101010101L) & ~value & 0x8080808080808080L) != 0L; }
	public static boolean hasZeroShort(int value) { return (value & 0xFFFF) == 0 || (value >>> 16) == 0; }
	public static boolean hasZeroShort(long value) { return ((value - 0x00010010001001L) & ~value & 0x8000800080008000L) != 0L; }
	public static boolean hasZeroInteger(long value) { return (value & 0xFFFFFFFFL) == 0 || (value >>> 32) == 0; }

	protected static final char[] HEX_ARRAY = "0123456789ABCDEF".toCharArray();
	public static String toHex(byte[] bytes) {
		int len = StringUtils.componentValueLength(bytes.length * 2, StringUtils.LATIN1);
		Object result = Array.newInstance(StringUtils.FIELD_TYPECOM_String_value, len);
		for(int i = 0; i < bytes.length; i++) { byte v = bytes[i];
			StringUtils.putCharAt(result, i * 2, HEX_ARRAY[(v & 0xF0) >> 4], StringUtils.LATIN1);
			StringUtils.putCharAt(result, i * 2 + 1, HEX_ARRAY[v & 0x0F], StringUtils.LATIN1);
	...
	public static int reverseBytes(int object) { return Integer.reverseBytes(object); }
	public static long reverseBytes(long object) { return Long.reverseBytes(object); }
	public static short reverseBytes(short object) { return Short.reverseBytes(object); }
	public static float reverseBytes(float object) { return Float.intBitsToFloat(reverseBytes(Float.floatToRawIntBits(object))); }
	public static double reverseBytes(double object) { return Double.longBitsToDouble(reverseBytes(Double.doubleToRawLongBits(object))); }
	public static char reverseBytes(char object) { return Character.reverseBytes(object); }
	public static int[] reverseBytes(int[] object, int[] result, int offObj, int offRes, int len) {
		ArrayUtils.assertIndex(offObj, object.length, len);
		ArrayUtils.assertIndex(offRes, result.length, len);
		int fit = (len / 8) * 8;
		int i = 0; for(; i < fit; i += 8) {
			result[offRes + i    ] = reverseBytes(object[offObj + i    ]);
			result[offRes + i + 1] = reverseBytes(object[offObj + i + 1]);
			result[offRes + i + 2] = reverseBytes(object[offObj + i + 2]);
			result[offRes + i + 3] = reverseBytes(object[offObj + i + 3]);
			result[offRes + i + 4] = reverseBytes(object[offObj + i + 4]);
			result[offRes + i + 5] = reverseBytes(object[offObj + i + 5]);
			result[offRes + i + 6] = reverseBytes(object[offObj + i + 6]);
			result[offRes + i + 7] = reverseBytes(object[offObj + i + 7]);
		}
		for(; i < len; i++) result[offRes + i] = reverseBytes(object[offObj + i]);
		return result;
	}
	public static long[] reverseBytes(long[] object, long[] result, int offObj, int offRes, int len) {
		ArrayUtils.assertIndex(offObj, object.length, len);
		ArrayUtils.assertIndex(offRes, result.length, len);
		int fit = (len / 8) * 8;
		int i = 0; for(; i < fit; i += 8) {
	...
	public static short[] reverseBytes(short[] object, short[] result, int offObj, int offRes, int len) {
		ArrayUtils.assertIndex(offObj, object.length, len);
		ArrayUtils.assertIndex(offRes, result.length, len);
		int fit = (len / 8) * 8;
		int i = 0; for(; i < fit; i += 8) {
	...
	public static float[] reverseBytes(float[] object, float[] result, int offObj, int offRes, int len) {
		ArrayUtils.assertIndex(offObj, object.length, len);
		ArrayUtils.assertIndex(offRes, result.length, len);
		int fit = (len / 8) * 8;
		int i = 0; for(; i < fit; i += 8) {
	...
	public static double[] reverseBytes(double[] object, double[] result, int offObj, int offRes, int len) {
		ArrayUtils.assertIndex(offObj, object.length, len);
		ArrayUtils.assertIndex(offRes, result.length, len);
		int fit = (len / 8) * 8;
		int i = 0; for(; i < fit; i += 8) {
	...
	public static char[] reverseBytes(char[] object, char[] result, int offObj, int offRes, int len) {
		ArrayUtils.assertIndex(offObj, object.length, len);
		ArrayUtils.assertIndex(offRes, result.length, len);
		int fit = (len / 8) * 8;
		int i = 0; for(; i < fit; i += 8) {
	...
	public static int[] reverseBytes(int[] object, int[] result, int offObj, int offRes) { return reverseBytes(object, result, offObj, offRes, object.length - offObj); }
	public static long[] reverseBytes(long[] object, long[] result, int offObj, int offRes) { return reverseBytes(object, result, offObj, offRes, object.length - offObj); }
	public static short[] reverseBytes(short[] object, short[] result, int offObj, int offRes) { return reverseBytes(object, result, offObj, offRes, object.length - offObj); }
	public static float[] reverseBytes(float[] object, float[] result, int offObj, int offRes) { return reverseBytes(object, result, offObj, offRes, object.length - offObj); }
	public static double[] reverseBytes(double[] object, double[] result, int offObj, int offRes) { return reverseBytes(object, result, offObj, offRes, object.length - offObj); }
	public static char[] reverseBytes(char[] object, char[] result, int offObj, int offRes) { return reverseBytes(object, result, offObj, offRes, object.length - offObj); }
	public static int[] reverseBytes(int[] object, int[] result, int offObj) { return reverseBytes(object, result, offObj, 0); }
	public static long[] reverseBytes(long[] object, long[] result, int offObj) { return reverseBytes(object, result, offObj, 0); }
	public static short[] reverseBytes(short[] object, short[] result, int offObj) { return reverseBytes(object, result, offObj, 0); }
	public static float[] reverseBytes(float[] object, float[] result, int offObj) { return reverseBytes(object, result, offObj, 0); }
	public static double[] reverseBytes(double[] object, double[] result, int offObj) { return reverseBytes(object, result, offObj, 0); }
	public static char[] reverseBytes(char[] object, char[] result, int offObj) { return reverseBytes(object, result, offObj, 0); }
	public static int[] reverseBytes(int[] object, int[] result) { return reverseBytes(object, result, 0); }
	public static long[] reverseBytes(long[] object, long[] result) { return reverseBytes(object, result, 0); }
	public static short[] reverseBytes(short[] object, short[] result) { return reverseBytes(object, result, 0); }
	public static float[] reverseBytes(float[] object, float[] result) { return reverseBytes(object, result, 0); }
	public static double[] reverseBytes(double[] object, double[] result) { return reverseBytes(object, result, 0); }
	public static char[] reverseBytes(char[] object, char[] result) { return reverseBytes(object, result, 0); }
	public static int[] reverseBytes(int[] object) { return reverseBytes(object, new int[object.length]); }
	public static long[] reverseBytes(long[] object) { return reverseBytes(object, new long[object.length]); }
	public static short[] reverseBytes(short[] object) { return reverseBytes(object, new short[object.length]); }
	public static float[] reverseBytes(float[] object) { return reverseBytes(object, new float[object.length]); }
	public static double[] reverseBytes(double[] object) { return reverseBytes(object, new double[object.length]); }
	public static char[] reverseBytes(char[] object) { return reverseBytes(object, new char[object.length]); }
}
