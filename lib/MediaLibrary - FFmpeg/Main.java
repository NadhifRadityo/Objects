...
public class Main extends Library {
	public static final String NAME = "MediaLibrary - FFmpeg";
	public static final String NATIVE_NAME = "MediaLibrary - FFmpeg - Natives";
	...
	public static final String NATIVE_DIR = "ffmpeg";
	public static final String GROUP = "org.bytedeco";
	public static final String ARTIFACT = "ffmpeg";
	...
	public static void build(Document dom, Element[] dependencies) throws Exception {
		File currentDir = Utils.getCurrentClassFile(Main.class).getParentFile();
		File ffmpegDir = new File(currentDir, NATIVE_DIR);
