...
public interface Easing {
	...
	/* ELASTIC */
	Easing ELASTIC_IN = Elastic.def_EASE_IN;
	Easing ELASTIC_OUT = Elastic.def_EASE_OUT;
	Easing ELASTIC_IN_OUT = Elastic.def_EASE_IN_OUT;
	static Easing ELASTIC_IN(float amplitude, float period) { return new Elastic.EASE_IN(amplitude, period); }
	static Easing ELASTIC_OUT(float amplitude, float period) { return new Elastic.EASE_OUT(amplitude, period); }
	static Easing ELASTIC_IN_OUT(float amplitude, float period) { return new Elastic.EASE_IN_OUT(amplitude, period); }

	/* BACK */
	Easing BACK_IN = Back.def_EASE_IN;
	Easing BACK_OUT = Back.def_EASE_OUT;
	Easing BACK_IN_OUT = Back.def_EASE_IN_OUT;
	static Easing BACK_IN(float overshoot) { return new Back.EASE_IN(overshoot); }
	static Easing BACK_OUT(float overshoot) { return new Back.EASE_OUT(overshoot); }
	static Easing BACK_IN_OUT(float overshoot) { return new Back.EASE_IN_OUT(overshoot); }
