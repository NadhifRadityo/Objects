...
public class WriteableInputStream extends InputStream {
	...
	public void write(int b) throws IOException { queue.add(new byte[] { ((Integer) b).byteValue() }); }
	...
	@Override public int available() throws IOException { retrieve(); return buffer.length - currentPos; }
}
