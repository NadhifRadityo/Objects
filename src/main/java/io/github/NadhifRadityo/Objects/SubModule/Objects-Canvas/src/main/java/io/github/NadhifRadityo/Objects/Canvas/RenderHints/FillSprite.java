...
public class FillSprite extends GraphicModifierManager.CustomGraphicModifier implements GraphicModifierManager.OverrideGraphic {
	protected boolean enabled;
	
	public FillSprite(boolean enabled, Sprite... sprites) { super(sprites); this.enabled = enabled; }
