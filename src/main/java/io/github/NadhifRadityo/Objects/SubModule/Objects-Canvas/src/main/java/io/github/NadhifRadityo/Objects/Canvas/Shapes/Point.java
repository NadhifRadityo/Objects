...
public class Point extends Circle {
	...
	@Override public void setPosition(int x, int y, boolean center) { throw new UnsupportedOperationException("Not implemented!"); }
	@Override public void setPosition(int x, int y) { setX(x); setY(y); }
