...
public class UnsafeUtils {
	...
	public static byte[] getTempByteArray(int length) {
	...
	public static ByteArrayOutputStream getTempOutputBuffer() {
	...
	public static ByteArrayInputStream getTempInputBuffer(byte[] bytes, int off, int len) {
