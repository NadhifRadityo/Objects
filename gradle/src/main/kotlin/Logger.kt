...
//	}
	...
	@JvmStatic
	val __injectLog: Array<Any?> = arrayOf("fwhite")
	@JvmStatic
	val __injectInfo: Array<Any?> = arrayOf("fbgreen")
	@JvmStatic
	val __injectDebug: Array<Any?> = arrayOf("fbblack")
	@JvmStatic
	val __injectWarn: Array<Any?> = arrayOf("fyellow")
	@JvmStatic
	val __injectError: Array<Any?> = arrayOf("fred")
