...
object Progress {
	...
	@ExportGradle
	@JvmStatic fun create(identifier: Any? = null, progressCategory: String?) {
		val instance = factory!!.newOperation(progressCategory)
		instances!![System.identityHashCode(identifier)] = instance
	}
	@ExportGradle
	@JvmStatic fun create(identifier: Any? = null, progressCategory: Class<*>?) {
		val instance = factory!!.newOperation(progressCategory)
		instances!![System.identityHashCode(identifier)] = instance
	}
	@ExportGradle
	@JvmStatic fun create(identifier: Any? = null, progressCategory: Class<*>?, buildOperationDescriptor: BuildOperationDescriptor?) {
		val instance = factory!!.newOperation(progressCategory, buildOperationDescriptor)
		instances!![System.identityHashCode(identifier)] = instance
	}
	@ExportGradle
	@JvmStatic fun create(identifier: Any? = null, progressCategory: Class<*>?, progressLogger: ProgressLogger?) {
	...
	@ExportGradle
	@JvmStatic fun instance(identifier: Any? = null): ProgressLogger? {
		return instances!![System.identityHashCode(identifier)]
	}

	@JvmStatic fun __on_start(identifier: Any? = null, callback: (ProgressLogger) -> Unit) {
	...
	@JvmStatic fun __on_do(identifier: Any? = null, callback: (ProgressLogger) -> Unit) {
		__on_start(identifier, callback)
	}
	@JvmStatic fun __on_end(identifier: Any? = null, callback: (ProgressLogger) -> Unit) {
	...
	@ExportGradle
	@JvmStatic fun pstart(identifier: Any? = null) {
		__on_start(identifier) { it.started() }
	}
	@ExportGradle
	@JvmStatic fun pstart(identifier: Any? = null, status: String?) {
		__on_start(identifier) { it.started(status) }
	}
	@ExportGradle
	@JvmStatic fun pstart(identifier: Any? = null, description: String?, status: String?) {
		__on_start(identifier) { it.start(description, status) }
	}
	@ExportGradle
	@JvmStatic fun pdo(identifier: Any? = null, status: String?) {
		__on_do(identifier) { it.progress(status) }
	}
	@ExportGradle
	@JvmStatic fun pdo(identifier: Any? = null, status: String?, failing: Boolean) {
		__on_do(identifier) { it.progress(status, failing) }
	}
	@ExportGradle
	@JvmStatic fun pend(identifier: Any? = null) {
		__on_end(identifier) { it.completed() }
	}
	@ExportGradle
	@JvmStatic fun pend(identifier: Any? = null, status: String?, failed: Boolean) {
